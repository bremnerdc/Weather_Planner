...
function currentOWA(cityName) {
    var query1URL =
    "https://api.openweathermap.org/data/2.5/weather?q=" + cityName + "&appid=6da06b04e4767b3319293983361bca86&units=imperial";
    $.ajax({
      url: query1URL,
      method: "GET",
     dataType: 'json',
...
// $(api.openweathermap.org/data/2.5/forecast?q={city name}&appid={6da06b04e4767b3319293983361bca86}
  ...
  function forecastOWA(cityName) {
    var query2URL =
    "https://api.openweathermap.org/data/2.5/forecast?q=" + cityName + "&appid=6da06b04e4767b3319293983361bca86&units=imperial";
    $.ajax({
      url: query2URL,
      method: "GET",
     dataType: 'json',
...
function uviOWA(lat, lon) {
  var query3URL =
  "https://api.openweathermap.org/data/2.5/uvi?q=&appid=6da06b04e4767b3319293983361bca86&lat=" + lat + "&lon=" + lon;
  $.ajax({
    url: query3URL,
    method: "GET",
   dataType: 'json',
